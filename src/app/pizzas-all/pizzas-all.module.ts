...
import {ProductsFilterPipe} from "../core/pipes/products-filter.pipe";
import {HighlightPipe} from "../core/pipes/highlight.pipe";
//import {CurrencyUaPipe} from "../../shared/pipes/currency-ua.pipe";


@NgModule({
  declarations: [PizzasAllComponent, PizzasBannerComponent,PizzaCardComponent,ProductsFilterPipe, HighlightPipe],
    imports: [
        CommonModule,
        PrimengModule,
        MaterialModule,
  ...
  providers: [ProductsFilterPipe, HighlightPipe]
